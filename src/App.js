...
import Housemap from './mycomponent/housemap'
    ...
    <div className="App">
      ...
      <Router>
            ...
            <Navbar.Collapse id="navbarScroll">
              ...
              >
                ...
                <NavDropdown title="Link" id="navbarScrollingDropdown">
                  <NavDropdown.Item href="/housemap">House Map</NavDropdown.Item>
        ...
        <Routes>
          ...
          <Route exact path="/housemap" element={<Housemap />}></Route>
              ...
              <div className="row">
                <div className="col-lg-4">
                  ...
                  <div className="bottom_nav_about_content">
                    <p>Dream Home was started in 2015, Dream Home is online platform where Architects, Civil
                            engineers, Interior Designers and Marketing Professionals from different locations have joined hands to
                            provide cost effective architectural solutions.
                    </p>
                  </div>
                </div>
                <div className="col-lg-4">
